...
public final class DriverFactory {
    ...
    private static final Map<RunModeType, Supplier<IWebDriver>> ADMIN = new EnumMap<>(RunModeType.class);
    ...
    static {
        ...
        ADMIN.put(RunModeType.LOCAL, LocalWebDriverImpl::new);
        ADMIN.put(RunModeType.REMOTE, RemoteWebDriverImpl::new);
    ...
    public static IWebDriver getDriverForAdmin(RunModeType runModeType){
        return ADMIN.get(runModeType).get();
    }
