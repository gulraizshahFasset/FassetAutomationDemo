...
public class JsonReader {
    ...
    public static int getSizeofJsonArray(String fileName,String jsonElement){
        try {
            fileName = OutputPathToFile+fileName+".json";
    ...
    public static JSONObject getJsonObject(String fileName, String jsonElement,String objectName){
        ...
        try {
            ...
            JSONObject jsonObject = (JSONObject) obj;
            jsonObject = (JSONObject) jsonObject.get(jsonElement);
            objectJson = (JSONObject) jsonObject.get(objectName);
            return objectJson;
        }
        catch (Exception ex){
            System.out.println(ex);
