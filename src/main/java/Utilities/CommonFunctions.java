...
public class CommonFunctions {
    public static Boolean waitUntilElementDisplayed(WebElement element,int timeOut) {
        Boolean flag = false;
        try {
            Wait<WebDriver> wait = new FluentWait<>(getDriver()).withTimeout(Duration.ofSeconds(timeOut))
    ...
    public static boolean waitForInvisibilityOfElement(WebElement element){
        Boolean flag = false;
        try {
            Wait<WebDriver> wait = new FluentWait<>(getDriver()).withTimeout(Duration.ofSeconds(10))
    ...
    public static void enterAmount(String amount){
        ...
        for (char c : charArray) {
            getDriver().findElement(By.xpath("//*[@text='"+c+"']")).click();
        }
    }
    public static void clickOnText(String text){
        waitUntilElementDisplayed(getDriver().findElement(By.xpath("//*[@text='"+text+"']")),5);
